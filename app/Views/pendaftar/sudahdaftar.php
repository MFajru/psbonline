    ...
    <div class="row">
        <div class="col">
            <div class="container-form">
                ...
                <a class="btn btn-primary" href="/home/cetak">Cetak</a>

                <p style="background-color: red;">Anda sudah mendaftar, tidak bisa mendaftar lagi.</p>

                <p><b>Keterangan: Isikan strip(-), jika tidak ada isi.</b></p>
                <form method="POST" action="/home/daftar">
                    <div class="row mb-3">
